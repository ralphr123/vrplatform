...
export function createCopyVideo(
  video: Omit<CopyVideo, "odataType">
): CopyVideo {
  return {
...
export function createCopyAudio(
  audio: Omit<CopyAudio, "odataType">
): CopyAudio {
  return {
...
export function createH264Video(
  video: Omit<H264Video, "odataType">
): H264Video {
  return {
...
export function createH264Layer(
  layer: Omit<H264Layer, "odataType">
): H264Layer {
  return {
...
export function createH265Video(
  video: Omit<H265Video, "odataType">
): H265Video {
  return {
...
export function createH265Layer(
  layer: Omit<H265Layer, "odataType">
): H265Layer {
  return {
...
export function createPngFormat(
  pngFormat: Omit<PngFormat, "odataType">
): PngFormat {
  return {
...
export function createJpgFormat(
  format: Omit<JpgFormat, "odataType">
): JpgFormat {
  return {
...
export function createStandardEncoderPreset(
  standardEncoder: Omit<StandardEncoderPreset, "odataType">
): StandardEncoderPreset {
  return {
...
export function createAudioAnalyzerPreset(
  audioAnalyserPreset: Omit<AudioAnalyzerPresetUnion, "odataType">
): AudioAnalyzerPreset {
  return {
...
export function createVideoAnalyzerPreset(
  videoAnalyserPreset: Omit<VideoAnalyzerPreset, "odataType">
): VideoAnalyzerPreset {
  return {
...
export function createMp4Format(
  mp4Format: Omit<Mp4Format, "odataType">
): Mp4Format {
  return {
...
export function createTSFormat(
  tsFormat: Omit<TransportStreamFormat, "odataType">
): TransportStreamFormat {
  return {
...
export function createSelectAudioTrackById(
  audioTrackById: Omit<SelectAudioTrackById, "odataType">
): SelectAudioTrackById {
  return {
...
export function createSelectAudioTrackByAttribute(
  audioTrackByAttribute: Omit<SelectAudioTrackByAttribute, "odataType">
): SelectAudioTrackByAttribute {
  return {
...
export function createInputFile(
  inputFile: Omit<InputFile, "odataType">
): InputFile {
  return {
...
export function createFromAllInputFile(
  fromAllInputFile: Omit<FromAllInputFile, "odataType">
): FromAllInputFile {
  return {
...
export function createFromEachInputFile(
  fromEachInputFile: Omit<FromEachInputFile, "odataType">
): FromEachInputFile {
  return {
...
export function createJobInputClip(
  inputAsset: Omit<JobInputClip, "odataType">
): JobInputClip {
  return {
...
export function createJobInputSequence(
  jobInputSequence: Omit<JobInputSequence, "odataType">
): JobInputSequence {
  return {
...
export function createJobInputs(
  jobInputs: Omit<JobInputs, "odataType">
): JobInputs {
  return {
...
export function createVideoOverlay(
  videoOverlay: Omit<VideoOverlay, "odataType">
): VideoOverlay {
  return {
